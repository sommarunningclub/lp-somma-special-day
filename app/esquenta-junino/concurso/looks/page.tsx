      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-xl font-dm text-base leading-relaxed text-somma-black/70">
              {votingOpen
                ? 'Conhece a galera, curte os looks e vota no seu favorito. Um voto por pessoa! 🌽'
                : 'A votação foi encerrada. Confere como ficou o ranking final dos looks! 🌽'}
            </p>
          </div>
        ...
        <div className="mt-8">
          <LookGallery initial={looks} showVotes={showVotes} votingOpen={votingOpen} />
        </div>
      </div>
    </main>
  )
