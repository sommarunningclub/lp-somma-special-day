...
// Bloco de atração especial (pagode "Resenha do Sabino") REMOVIDO até segunda ordem.
// Para restaurar: recupere a função atracaoBlock() e sua chamada no corpo do template
// a partir do commit e0159bd (feat(reguas): adiciona bloco de atracao especial ...).
